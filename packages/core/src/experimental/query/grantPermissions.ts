...
export function grantPermissionsMutationOptions<config extends Config>(config: config) {
    return {
...
export type GrantPermissionsMutate<context = unknown> = (
    ...
    options?: Compute<MutateOptions<GrantPermissionsData, GrantPermissionsErrorType, GrantPermissionsVariables, context>> | undefined
) => void
